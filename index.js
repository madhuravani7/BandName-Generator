...
app.post("/submit", (req, res) => {
  ...
  const index1 = adj[Math.floor(Math.random() * adj.length)];
  const index2 = noun[Math.floor(Math.random() * noun.length)];
  //const bandName = adj[index1] +" "+  noun[index2]; 
  res.render('index.ejs', {adjective: index1, noun: index2});
